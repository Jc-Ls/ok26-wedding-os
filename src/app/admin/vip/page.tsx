  ...
  return (
    <div style={{ padding: '40px 20px', fontFamily: '"Montserrat", sans-serif', backgroundColor: '#050505', color: '#FDFBF7', minHeight: '100vh', textAlign: 'center' }}>
      ...
      <div style={{ backgroundColor: '#111', padding: '30px', borderRadius: '12px', border: '1px solid #333', maxWidth: '400px', margin: '0 auto' }}>
        <input type="number" value={count} onChange={(e) => setCount(Number(e.target.value))} style={{ width: '100%', padding: '15px', backgroundColor: '#000', border: '1px solid #333', color: '#fff', borderRadius: '8px', marginBottom: '20px', outline: 'none', textAlign: 'center', fontSize: '1.2rem' }} />
        <button onClick={generateCodes} style={{ width: '100%', padding: '15px', backgroundColor: '#D4AF37', color: '#000', fontWeight: 'bold', border: 'none', borderRadius: '8px', cursor: 'pointer' }}>Generate Codes</button>
